...
// Stunning Aeva HTML email template
const emailHtml = `
<!DOCTYPE html>
<html>
<head>
...
console.log(`Attempting to send sync email from ${gmailUser} to ${recipient}...`);

transporter.sendMail(mailOptions, (error, info) => {
  if (error) {
    console.error("Error occurred while sending SMTP email:");
